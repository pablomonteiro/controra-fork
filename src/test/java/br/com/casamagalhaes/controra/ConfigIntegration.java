...
import br.com.casamagalhaes.controra.config.DBIntegration;
...
public class ConfigIntegration {
    ...
    protected static void registryEntity(Class clazz) {
        if(isNull(entities))
            entities = new ArrayList<>();
        entities.add(clazz);
    }

    protected static void registryEntities(List<Class> classes) {
        if(isNull(entities))
            entities = new ArrayList<>();
